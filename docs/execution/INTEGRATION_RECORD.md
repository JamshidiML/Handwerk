...
| Root build and test    | `npm test`                                                                              | 273 passed; 11 PostgreSQL integration tests correctly skipped without the explicit synthetic test URL                                                |
...
| Browser                | `npm run test:e2e`                                                                      | Clean detached `ffcfdd3`: 35 passed in 41.5s; native hosted Ubuntu: 35 passed in 30.8s; fresh Vinext server owned by Playwright                      |
...
| Clean checkout         | Detached `ffcfdd3` checkout; every required Cycle 2 command                             | Install: 582 packages in 51s; inventory/quality passed; 273 root with 11 expected DB skips; dedicated DB 11/11; E2E 35/35; secrets and audits passed |
| Hosted CI              | PR run [`31699278297`](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297) | All six jobs passed on attempt 1 for `ffcfdd3`; PostgreSQL passed 11/11 and native Ubuntu browser acceptance passed 35/35                            |
| Hosted artifact        | `dependency-evidence`, artifact `9180580274`                                            | 97,987-byte ZIP retained for 14 days; exactly `dependency-inventory.json` and `sbom.cdx.json`                                                        |
...
| ------------------------------------------------------------------------------------------------------------------------ | ------------: | ------------------------- | -------: |
| [Quality (Node 22.13.0)](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201143)                | `94444201143` | Passed                    |   1m 13s |
| [Quality (Node 26.3.0)](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201183)                 | `94444201183` | Passed                    |   1m 06s |
| [Unit and build](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201152)                        | `94444201152` | Passed, 273               |   1m 31s |
| [PostgreSQL integration and migrations](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201112) | `94444201112` | Passed, 11/11             |   1m 07s |
| [Browser acceptance](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201146)                    | `94444201146` | Passed, 35/35             |   2m 07s |
| [Secrets, audit, and inventory](https://github.com/JamshidiML/Handwerk/actions/runs/31699278297/job/94444201378)         | `94444201378` | Passed, artifact uploaded |      39s |

Run `31699278297` was a `pull_request` event for head `ffcfdd3ac6ab97b67aba09d4d4b411c9fb7d5fef`. There were no retries. Earlier run `31696348445` is retained as native-binding/artifact evidence but not counted for PostgreSQL because its 11 tests were skipped.
